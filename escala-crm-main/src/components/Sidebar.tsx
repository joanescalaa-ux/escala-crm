...
import {
  ...
  User, Settings, LogOut, Plus, ChevronRight, Map
} from 'lucide-react'
...
const clienteNavItems = [
  { href: '/programa', label: 'Mi Programa', icon: Map },
            ...
            {adminOnlyItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  style={{
                    height: 48,
                    backgroundColor: active ? 'rgba(248,242,132,0.12)' : 'transparent',
                    color: active ? '#F8F284' : 'rgba(255,255,255,0.45)',
                    fontSize: 13,
                    fontWeight: active ? 600 : 300,
                    letterSpacing: '0.06em',
                    textDecoration: 'none',
